import { PrismaClient, type AvailabilityStatus, type EngagementRoute, type Seniority, type HumanDecision, type AccountKind } from "@prisma/client";
import { parseBrief, matchBrief, defaultFeeModel, defaultTerms, DEFAULT_RATE_CARD } from "../src/lib/demand";
...
const PEOPLE: SeedPerson[] = [
  { key: "sarah", screenedDaysAgo: 40, attrs: { assertiveness: 5, conflict: 5, political: 4, commercial: 4, collaboration: 3, ambiguity: 4, influence: 5, pace: 4 }, rights: ["Right to work in UK"], firstName: "Sarah", lastName: "Okonkwo", headline: "Programme director who stabilises troubled transformations", currentCompany: "Independent", currentRole: "Programme Director", city: "London", country: "UK", targetLocations: ["Dubai", "Riyadh"], capabilities: ["Programme director", "Transformation", "Systems integrator challenge", "Turnaround", "Stakeholder management"], sectors: ["Banking", "Financial services"], seniority: "DIRECTOR", routes: ["INTERIM", "CONTRACT", "SOW"], rate: "£1,350/day", status: "FINISHING_ENGAGEMENT_SOON", confirmedDaysAgo: 6, relocation: true, amanaBench: true, usedByAmana: true, email: "sarah.okonkwo@example.com", nextAction: "Confirm end date of current programme" },
  { key: "daniel", rights: ["Right to work in UK"], firstName: "Daniel", lastName: "Reyes", headline: "CISO / security architecture, regulated industries", currentCompany: "Northgate Insurance", currentRole: "Deputy CISO", city: "Manchester", country: "UK", capabilities: ["Cyber security", "Security architecture", "CISO", "Identity and access", "Regulatory"], sectors: ["Insurance", "Financial services"], seniority: "EXECUTIVE", routes: ["FRACTIONAL", "ADVISORY", "PERMANENT"], salary: "£185k", status: "QUIETLY_EXPLORING", confirmedDaysAgo: 20, amanaBench: true, email: "daniel.reyes@example.com", nextAction: "Send fractional CISO framing" },
  { key: "amira", rights: ["UAE residence visa"], firstName: "Amira", lastName: "Haddad", headline: "Data platform and AI delivery lead", currentCompany: "Gulf Capital Partners", currentRole: "Head of Data", city: "Dubai", country: "UAE", capabilities: ["Data platform", "Data engineering", "AI", "Machine learning", "Azure", "Delivery lead"], sectors: ["Sovereign wealth", "Financial services"], seniority: "SENIOR_MANAGER", routes: ["PERMANENT", "SOW"], salary: "AED 65k/month", status: "RIGHT_OPPORTUNITY_ONLY", confirmedDaysAgo: 35, amanaBench: true, usedByAmana: true, email: "amira.haddad@example.com" },
  { key: "tom", screenedDaysAgo: 50, attrs: { assertiveness: 4, conflict: 3, political: 4, commercial: 5, collaboration: 4, ambiguity: 4, influence: 4, pace: 3 }, rights: ["Right to work in UK"], firstName: "Tom", lastName: "Whitfield", headline: "Fractional CFO for scale-ups and carve-outs", currentCompany: "Whitfield Advisory", currentRole: "Fractional CFO", city: "Edinburgh", country: "UK", capabilities: ["Finance transformation", "CFO", "M&A integration", "Commercial", "Governance"], sectors: ["Technology", "Retail"], seniority: "EXECUTIVE", routes: ["FRACTIONAL", "ADVISORY"], rate: "£1,600/day", status: "FRACTIONAL_AVAILABILITY", confirmedDaysAgo: 12, email: "tom.whitfield@example.com" },
  { key: "priya", screenedDaysAgo: 30, attrs: { assertiveness: 3, conflict: 4, political: 4, commercial: 3, collaboration: 5, ambiguity: 4, influence: 4, pace: 3 }, rights: ["Right to work in UK"], firstName: "Priya", lastName: "Natarajan", headline: "Change and target operating model lead", currentCompany: "Independent", currentRole: "Change Director", city: "London", country: "UK", targetLocations: ["Abu Dhabi"], capabilities: ["Change management", "Target operating model", "Transformation", "PMO", "Stakeholder management"], sectors: ["Public sector", "Healthcare"], seniority: "DIRECTOR", routes: ["CONTRACT", "SOW", "INTERIM"], rate: "£1,100/day", status: "AVAILABLE_NOW", confirmedDaysAgo: 3, amanaBench: true, usedByAmana: true, email: "priya.n@example.com", nextAction: "Introduce to Meridian if route confirmed" },
  { key: "james", rights: ["Right to work in UK"], firstName: "James", lastName: "Carrick", headline: "ERP programme lead (SAP S/4)", currentCompany: "Carrick Delivery Ltd", currentRole: "Programme Lead", city: "Birmingham", country: "UK", capabilities: ["SAP", "ERP", "Programme management", "Vendor management", "Systems integrator challenge"], sectors: ["Manufacturing", "Utilities"], seniority: "DIRECTOR", routes: ["CONTRACT", "SOW"], rate: "£1,250/day", status: "NEEDS_REFRESH", confirmedDaysAgo: 120, email: "james.carrick@example.com", nextAction: "Reconnect — status stale" },
  { key: "layla", rights: ["Right to work in Saudi Arabia"], firstName: "Layla", lastName: "Mansour", headline: "Enterprise architect, cloud and integration", currentCompany: "Riyadh Digital Authority", currentRole: "Chief Architect", city: "Riyadh", country: "Saudi Arabia", capabilities: ["Enterprise architecture", "Cloud", "AWS", "Solution architecture", "Governance"], sectors: ["Government", "Public sector"], seniority: "EXECUTIVE", routes: ["ADVISORY", "SOW"], rate: "SAR 6,500/day", status: "SOW_ONLY", confirmedDaysAgo: 28, amanaBench: true, email: "layla.mansour@example.com" },
  { key: "oliver", rights: ["Right to work in UK"], firstName: "Oliver", lastName: "Bennett", headline: "Product and agile delivery leader", currentCompany: "Fintech scale-up", currentRole: "VP Product", city: "London", country: "UK", capabilities: ["Product management", "Agile delivery", "Platform engineering", "Stakeholder management"], sectors: ["Financial services", "Technology"], seniority: "SENIOR_MANAGER", routes: ["PERMANENT"], salary: "£160k + equity", status: "HAPPY_WHERE_I_AM", confirmedDaysAgo: 40, email: "oliver.bennett@example.com" },
  { key: "fatima", screenedDaysAgo: 12, attrs: { assertiveness: 3, conflict: 3, political: 4, commercial: 3, collaboration: 4, ambiguity: 3, influence: 3, pace: 3 }, rights: ["UAE residence visa (own sponsorship)"], firstName: "Fatima", lastName: "Al Rashid", headline: "Cyber governance, risk and compliance", currentCompany: "Independent", currentRole: "GRC Consultant", city: "Abu Dhabi", country: "UAE", capabilities: ["Cyber security", "Governance", "Risk", "Compliance", "Regulatory"], sectors: ["Energy", "Government"], seniority: "MANAGER", routes: ["CONTRACT", "SOW"], rate: "AED 4,200/day", status: "AVAILABLE_NOW", confirmedDaysAgo: 8, amanaBench: true, email: "fatima.ar@example.com" },
  { key: "marcus", screenedDaysAgo: 60, attrs: { assertiveness: 5, conflict: 5, political: 3, commercial: 5, collaboration: 3, ambiguity: 5, influence: 4, pace: 5 }, rights: ["Right to work in UK"], firstName: "Marcus", lastName: "Doyle", headline: "Interim COO, operations turnaround", currentCompany: "Independent", currentRole: "Interim COO", city: "Leeds", country: "UK", targetLocations: ["Dubai"], capabilities: ["Operations", "Turnaround", "COO", "Supply chain", "Target operating model"], sectors: ["Logistics", "Retail"], seniority: "C_LEVEL", routes: ["INTERIM", "FRACTIONAL"], rate: "£1,800/day", status: "OPEN_TO_CONVERSATIONS", confirmedDaysAgo: 15, relocation: true, email: "marcus.doyle@example.com" },
  { key: "hannah", rights: ["Right to work in UK (settled status)"], firstName: "Hannah", lastName: "Lindqvist", headline: "GenAI strategy and responsible AI", currentCompany: "Nordic Bank", currentRole: "Head of AI", city: "London", country: "UK", capabilities: ["AI", "GenAI", "Data strategy", "Governance", "Machine learning"], sectors: ["Banking", "Financial services"], seniority: "DIRECTOR", routes: ["ADVISORY", "FRACTIONAL"], rate: "£1,900/day", status: "RIGHT_OPPORTUNITY_ONLY", confirmedDaysAgo: 22, amanaBench: true, email: "hannah.l@example.com" },
  { key: "ravi", rights: ["Right to work in UK"], firstName: "Ravi", lastName: "Menon", headline: "PMO and portfolio governance", currentCompany: "Carrick Delivery Ltd", currentRole: "PMO Lead", city: "Birmingham", country: "UK", capabilities: ["PMO", "Project management", "Governance", "Programme management"], sectors: ["Utilities", "Manufacturing"], seniority: "MANAGER", routes: ["CONTRACT", "SOW"], rate: "£650/day", status: "OPEN_TO_CONVERSATIONS", confirmedDaysAgo: 50, usedByAmana: true, email: "ravi.menon@example.com" },
  { key: "chloe", rights: ["Right to work in UK"], firstName: "Chloe", lastName: "Martin", headline: "ServiceNow and IT operating model", currentCompany: "Independent", currentRole: "Platform Lead", city: "Bristol", country: "UK", capabilities: ["ServiceNow", "Target operating model", "Platform engineering", "Vendor management"], sectors: ["Telecoms", "Public sector"], seniority: "SENIOR_MANAGER", routes: ["CONTRACT"], rate: "£850/day", status: "CONTRACT_ONLY", confirmedDaysAgo: 10, email: "chloe.martin@example.com" },
  { key: "khalid", rights: ["UAE golden visa"], firstName: "Khalid", lastName: "Farouk", headline: "Bid and proposal director, GCC public sector", currentCompany: "Independent", currentRole: "Bid Director", city: "Dubai", country: "UAE", capabilities: ["Bid management", "Proposal", "Commercial", "SOW", "Stakeholder management"], sectors: ["Government", "Defence"], seniority: "DIRECTOR", routes: ["SOW", "ADVISORY"], rate: "AED 5,000/day", status: "NOT_LOOKING_KEEP_IN_TOUCH", confirmedDaysAgo: 30, usedByAmana: true, amanaBench: true, email: "khalid.f@example.com" },
  { key: "emma", rights: ["Right to work in UK"], firstName: "Emma", lastName: "Fitzgerald", headline: "Regulatory change and compliance programmes", currentCompany: "Global Bank", currentRole: "Head of Regulatory Change", city: "London", country: "UK", capabilities: ["Regulatory", "Compliance", "Programme management", "Change management"], sectors: ["Banking"], seniority: "DIRECTOR", routes: ["PERMANENT"], salary: "£175k", status: "QUIETLY_EXPLORING", confirmedDaysAgo: 9, email: "emma.f@example.com" },
  { key: "yusuf", rights: ["Right to work in UK", "UAE residence visa"], firstName: "Yusuf", lastName: "Demir", headline: "DevOps and platform engineering lead", currentCompany: "Independent", currentRole: "Platform Engineering Lead", city: "London", country: "UK", targetLocations: ["Remote", "Dubai"], capabilities: ["DevOps", "Platform engineering", "Cloud", "Azure", "Engineering lead"], sectors: ["Technology", "Media"], seniority: "SENIOR_MANAGER", routes: ["CONTRACT", "SOW"], rate: "£900/day", status: "TAKING_A_BREAK", confirmedDaysAgo: 18, email: "yusuf.d@example.com" },
  { key: "grace", rights: ["Right to work in UK"], firstName: "Grace", lastName: "Adeyemi", headline: "Procurement and supply chain transformation", currentCompany: "Independent", currentRole: "Procurement Director", city: "London", country: "UK", capabilities: ["Procurement", "Supply chain", "Transformation", "Commercial", "Vendor management"], sectors: ["Retail", "Consumer", "Public sector"], seniority: "DIRECTOR", routes: ["INTERIM", "CONTRACT"], rate: "£1,000/day", status: "NEEDS_REFRESH", confirmedDaysAgo: null, email: "grace.a@example.com", nextAction: "First proper conversation not yet held" },
  { key: "nadia", screenedDaysAgo: 20, attrs: { assertiveness: 4, conflict: 3, political: 3, commercial: 3, collaboration: 5, ambiguity: 3, influence: 4, pace: 4 }, rights: ["UAE residence visa"], firstName: "Nadia", lastName: "Rahman", headline: "Senior business analyst, core banking and payments", currentCompany: "Emirates Digital Bank", currentRole: "Lead Business Analyst", city: "Dubai", country: "UAE", capabilities: ["Business analysis", "Requirements", "Core banking", "Payments", "Agile delivery"], sectors: ["Banking", "Financial services"], seniority: "SENIOR_MANAGER", routes: ["PERMANENT", "CONTRACT"], salary: "AED 420k", status: "OPEN_TO_CONVERSATIONS", confirmedDaysAgo: 9, email: "nadia.rahman@example.com" },
  { key: "omar", rights: ["UAE residence visa"], firstName: "Omar", lastName: "Haddad", headline: "Business analyst turned product owner, retail banking", currentCompany: "Independent", currentRole: "Business Analyst", city: "Dubai", country: "UAE", capabilities: ["Business analysis", "Product ownership", "Retail banking", "Process mapping"], sectors: ["Banking"], seniority: "MANAGER", routes: ["CONTRACT", "PERMANENT"], rate: "AED 2,400/day", salary: "AED 300k", status: "AVAILABLE_NOW", confirmedDaysAgo: 4 },
  { key: "isha", rights: ["UAE employment visa (sponsored by current employer)"], firstName: "Isha", lastName: "Verma", headline: "Project manager, digital banking programmes", currentCompany: "Gulf Retail Bank", currentRole: "Senior Project Manager", city: "Abu Dhabi", country: "UAE", capabilities: ["Project management", "Digital banking", "Agile delivery", "Vendor management"], sectors: ["Banking"], seniority: "SENIOR_MANAGER", routes: ["PERMANENT"], salary: "AED 480k", status: "QUIETLY_EXPLORING", confirmedDaysAgo: 18 },
  { key: "leila", registeredDaysAgo: 1, firstName: "Leila", lastName: "Osman", headline: "Registered via a member invitation — regulatory change, insurance", currentCompany: "Unknown", currentRole: "Regulatory Change Manager", city: "London", country: "UK", capabilities: ["Regulatory", "Change management"], sectors: ["Insurance"], seniority: "MANAGER", routes: [], status: "NEEDS_REFRESH", confirmedDaysAgo: null, nextAction: "Screening call", email: "leila@example.com" },
...
async function main() {
  ...
  await prisma.$transaction([
    ...
    prisma.feeLine.deleteMany(),
    prisma.shortlistItem.deleteMany(),
    prisma.brief.deleteMany(),
    prisma.commercialAccount.deleteMany(),
  ...
  for (const p of PEOPLE) {
    ...
    people[p.key] = await prisma.person.create({
      data: {
        ...
        workRights: p.rights ?? [],
        screenedAt: p.screenedDaysAgo ? daysAgo(p.screenedDaysAgo) : null,
        screeningStatus: p.screenedDaysAgo ? "APPROVED" : p.registeredDaysAgo ? "REGISTERED" : "NONE",
        referralConsent: p.screenedDaysAgo ? "yes" : null,
        memberSince: p.screenedDaysAgo ? daysAgo(p.screenedDaysAgo) : p.registeredDaysAgo ? daysAgo(p.registeredDaysAgo) : null,
        attributes: p.attrs ?? undefined,
  ...
  await rel("nadia", waqas.id, { sourceType: "WORKED_TOGETHER", relationshipType: "WORKED_WITH", workedTogether: true, workedTogetherContext: "Payments platform programme in Dubai, 2023. Ran the requirements workstream.", yearsKnown: 3, wouldWorkTogetherAgain: true, relationshipNotes: "Precise, calm, well liked by the business. Wants to stay in Dubai.", lastContactDate: daysAgo(9) });
  await rel("omar", richard.id, { sourceType: "INTRODUCTION", introducedById: people["nadia"].id, relationshipType: "INTRODUCED", yearsKnown: 1, relationshipNotes: "Nadia rates him; worked under her on payments.", lastContactDate: daysAgo(4) });
  await rel("isha", waqas.id, { sourceType: "EVENT", relationshipType: "DIRECT", yearsKnown: 2, relationshipNotes: "Met at the Abu Dhabi fintech forum. Sponsored by current employer; a move would need a visa transfer.", lastContactDate: daysAgo(18) });
  ...
  await ev("nadia", waqas.id, { evidenceType: "DELIVERY_OBSERVED", context: "Business analysis, payments, banking", description: "Owned the requirements for a payments hub; zero defects traced to requirements at go-live.", confidence: 90, daysAgo: 500, visibility: "PARTNER_SAFE" });
  ...
  // Referral network: member logins, vouches, referrals, a pitch (spec: people who know people)
  await prisma.user.create({ data: { tenantId: founderTenant.id, email: "nadia.rahman@example.com", name: "Nadia Rahman", role: "MEMBER", personId: people["nadia"].id, passwordHash } });
  await prisma.user.create({ data: { tenantId: founderTenant.id, email: "sarah.okonkwo@example.com", name: "Sarah Okonkwo", role: "MEMBER", personId: people["sarah"].id, passwordHash } });
  const vouch = (key: string, v: { kind: "USER" | "PERSON" | "EXTERNAL"; userId?: string; personKey?: string; name?: string; source?: string; context: string; statement?: string; attrs?: Record<string, number>; daysAgo: number }) =>
    prisma.vouch.create({ data: { personId: people[key].id, voucherKind: v.kind, voucherUserId: v.userId ?? null, voucherPersonId: v.personKey ? people[v.personKey].id : null, voucherName: v.name ?? null, source: v.source ?? null, context: v.context, statement: v.statement ?? null, wouldRecommend: true, attributes: v.attrs, createdAt: daysAgo(v.daysAgo) } });
  await vouch("sarah", { kind: "USER", userId: waqas.id, context: "Core banking recovery, 2021–22", statement: "The only person the SI was afraid of. I would put her into any red programme.", attrs: { assertiveness: 5, conflict: 5, political: 5, commercial: 4, influence: 5 }, daysAgo: 300 });
  await vouch("sarah", { kind: "EXTERNAL", name: "Former CIO, Tier-1 bank", source: "LinkedIn recommendation", context: "Core banking programme", statement: "Sarah re-baselined a failing programme and restored the board's confidence within a quarter.", daysAgo: 500 });
  await vouch("sarah", { kind: "PERSON", personKey: "priya", context: "Worked under her on the NHS operating model", statement: "Calm, direct, and the board listened to her.", attrs: { assertiveness: 5, conflict: 4, political: 4, collaboration: 3, influence: 5 }, daysAgo: 90 });
  await vouch("sarah", { kind: "PERSON", personKey: "tom", context: "Carve-out finance workstream", statement: "Kept the whole programme honest.", daysAgo: 45 });
  await vouch("nadia", { kind: "USER", userId: waqas.id, context: "Payments platform programme, Dubai", statement: "Requirements were the one thing that never slipped.", attrs: { assertiveness: 4, conflict: 3, political: 4, commercial: 3, collaboration: 5, pace: 4 }, daysAgo: 200 });
  await vouch("nadia", { kind: "PERSON", personKey: "omar", context: "Worked under her on payments", statement: "Taught me how to run a requirements workshop properly.", daysAgo: 20 });
  await vouch("priya", { kind: "USER", userId: waqas.id, context: "NHS trust operating model", daysAgo: 400 });
  await vouch("priya", { kind: "USER", userId: soban.id, context: "Amana public sector SOW", daysAgo: 100 });
  await vouch("marcus", { kind: "USER", userId: waqas.id, context: "Logistics turnaround", attrs: { assertiveness: 5, conflict: 5, political: 2, commercial: 5, ambiguity: 5, pace: 5 }, daysAgo: 900 });
  await vouch("khalid", { kind: "USER", userId: richard.id, context: "Two Amana bids", daysAgo: 150 });
  await vouch("omar", { kind: "PERSON", personKey: "nadia", context: "Payments hub, ran the BA workstream with me", statement: "Fast, thorough, and the business trusted him.", daysAgo: 15 });

  // Demand: accounts, briefs (parsed by the co-pilot), fee lines (spec §4, §10)
  const gulfTenant = await prisma.tenant.findUnique({ where: { slug: "gulf-talent-partners" } });
  const gulfPartner = await prisma.partner.findFirst({ where: { name: "Gulf Talent Partners" } });
  const accounts = {
    amana: await prisma.commercialAccount.create({ data: { tenantId: founderTenant.id, name: "Amana Expert Network", kind: "EXPERT_NETWORK", status: "ACTIVE", contactName: "Richard Cole", currency: "GBP", notes: "Sister consultancy. SOW resourcing and expert calls." } }),
    harbour: await prisma.commercialAccount.create({ data: { tenantId: founderTenant.id, name: "Harbour Search", kind: "AGENCY", status: "ACTIVE", contactName: "Jo Harbour", contactEmail: "partner@harboursearch.local", currency: "GBP", monthlyFee: 1500, partnerId: partner.id, portalTenantId: partnerTenant.id, notes: "Licensed UK recruiter. Referral share on perm, margin share on contract." } }),
    gulf: await prisma.commercialAccount.create({ data: { tenantId: founderTenant.id, name: "Gulf Talent Partners", kind: "AGENCY", status: "ACTIVE", contactName: "Omar Siddiqui", currency: "AED", partnerId: gulfPartner?.id ?? null, portalTenantId: gulfTenant?.id ?? null, notes: "UAE / KSA agency." } }),
    meridian: await prisma.commercialAccount.create({ data: { tenantId: founderTenant.id, name: "Meridian Energy", kind: "CLIENT", status: "ACTIVE", contactName: "Sophie Grant", currency: "GBP", portalTenantId: clientTenant.id } }),
    clienta: await prisma.commercialAccount.create({ data: { tenantId: founderTenant.id, name: "Client A · Dubai retail bank", kind: "CLIENT", status: "PROSPECT", contactName: "Hamad Al Mazrouei", currency: "AED", notes: "Direct client. Perm hires, pays a success fee." } }),
  };
  const briefFrom = async (account: { id: string; kind: AccountKind }, text: string, over: { submittedVia?: "OWNER" | "PORTAL"; status?: "NEW" | "QUALIFYING" | "SEARCHING" | "SHORTLISTED" | "INTRODUCING" | "FILLED" | "CLOSED"; expertHours?: number; termsAccepted?: boolean; termsAcceptedAt?: Date; openToMembers?: boolean; memberSummary?: string } = {}) => {
    const parsed = parseBrief(text); const terms = defaultTerms(DEFAULT_RATE_CARD, defaultFeeModel(parsed.engagementRoute, account.kind));
    return prisma.brief.create({ data: { tenantId: founderTenant.id, accountId: account.id, submittedVia: "OWNER", status: "SEARCHING", rawText: parsed.rawText, title: parsed.title, engagementRoute: parsed.engagementRoute, headcount: parsed.headcount, roles: parsed.roles, capabilities: parsed.capabilities, sectors: parsed.sectors, seniority: parsed.seniority, locations: parsed.locations, mustBeLocal: parsed.mustBeLocal, workRights: parsed.workRights, budgetKind: parsed.budget?.kind ?? null, budgetAmount: parsed.budget?.amount ?? null, budgetMax: parsed.budget?.max ?? null, budgetCurrency: parsed.budget?.currency ?? null, durationMonths: parsed.durationMonths, startBy: parsed.startBy, assumptions: parsed.assumptions, questions: parsed.questions, feeModel: terms.model, feePct: terms.pct, feeFlat: terms.flat, feeCurrency: terms.currency, ...over } });
  };
  const b1 = await briefFrom(accounts.gulf, "Gulf Talent Partners is looking for 2 BAs already in Dubai with a visa, perm, retail banking, AED 360k, start asap", { submittedVia: "PORTAL", status: "SHORTLISTED", openToMembers: true, memberSummary: "Two permanent business analysts for a retail bank in Dubai. Must already be in the UAE with the right to work. Payments or core banking experience helps." });
  await briefFrom(accounts.clienta, "Client A wants a perm project manager for a digital banking programme in Dubai, AED 480k, senior, start in January", { status: "QUALIFYING" });
  const b3 = await briefFrom(accounts.amana, "Expert call: 2 hours with someone who has run an SAP S/4 go-live assurance review for a utility, £600/hour, this week", { status: "INTRODUCING", expertHours: 2, termsAccepted: true, termsAcceptedAt: daysAgo(5) });
  const b4 = await briefFrom(accounts.meridian, "Fractional operations lead 2 days a week to build the Dubai operating model, £1,700/day, 9 months, must be willing to spend time in Dubai. Needs someone commercially aware who can push back on the local team.", { termsAccepted: true, termsAcceptedAt: daysAgo(10), openToMembers: true, memberSummary: "Fractional operations lead, two days a week for nine months, building a Dubai operating model for an energy company. Needs someone who has built an operation from scratch and will spend time on the ground." });
  await prisma.referral.create({ data: { tenantId: founderTenant.id, referrerPersonId: people["nadia"].id, referredPersonId: people["omar"].id, name: "Omar Haddad", context: "Worked under me on the payments hub", note: "Would suit the Dubai BA requirement.", briefId: b1.id, status: "ACCEPTED", createdAt: daysAgo(6) } });
  await prisma.referral.create({ data: { tenantId: founderTenant.id, referrerPersonId: people["sarah"].id, name: "Ben Hughes", email: "ben@example.com", context: "Ran programme recovery for me on the insurance programme", note: "Good with systems integrators.", status: "NEW", createdAt: daysAgo(2) } });
  await prisma.pitch.create({ data: { briefId: b4.id, personId: people["marcus"].id, note: "I built the Gulf operation for a logistics group from nothing. Happy to be in Dubai two weeks a month.", status: "SUBMITTED", createdAt: daysAgo(1) } });
  await prisma.feeLine.createMany({ data: [
    { tenantId: founderTenant.id, briefId: b3.id, accountId: accounts.amana.id, personId: people["james"].id, model: "EXPERT_HOURLY", basis: "30% of £600/hour × 2 hours", gross: 1200, ourTake: 360, currency: "GBP", status: "AGREED" },
    { tenantId: founderTenant.id, briefId: b4.id, accountId: accounts.meridian.id, personId: people["marcus"].id, model: "CONTRACT_MARGIN", basis: "12% of £1,700/day × 165 days (9 mo)", gross: 280500, ourTake: 33660, currency: "GBP", status: "FORECAST" },
    { tenantId: founderTenant.id, briefId: b1.id, accountId: accounts.gulf.id, model: "AGENCY_REFERRAL", basis: "35% of the agency's 20% fee on AED 360,000 × 2 people", gross: 144000, ourTake: 50400, currency: "AED", status: "FORECAST" },
    { tenantId: founderTenant.id, briefId: b3.id, accountId: accounts.amana.id, personId: people["sarah"].id, model: "SOW_SHARE", basis: "10% of £300,000 SOW value", gross: 300000, ourTake: 30000, currency: "GBP", status: "INVOICED" },
  ] });
  ...
  // Shortlist for the agency brief, generated with the real engine; one person proposed to the agency.
  {
    const briefPeople = allPeople.map((p) => ({ ...matchInputs.find((m) => m.id === p.id)!, workRights: p.workRights, relocationInterest: p.relocationInterest }));
    const results = matchBrief(parseBrief(b1.rawText), briefPeople, 12);
    for (const r of results) await prisma.shortlistItem.create({ data: { briefId: b1.id, personId: r.match.personId, fitScore: r.match.fitScore, fitExplanation: r.match.fitExplanation, dimensions: r.match.dimensions, uncertainty: r.match.uncertainty, checks: r.checks, tier: r.tier, decision: r.match.personId === people["nadia"].id ? "PROPOSED" : "CANDIDATE", clientNote: r.match.personId === people["nadia"].id ? "Ran the payments BA workstream we saw first hand." : null } });
  }

  console.log(`Seeded ${PEOPLE.length} people, 6 opportunities, 4 requirements, 3 tenants, member logins and vouches.`);
