  ...
  return (
    <div className="flex items-end justify-between gap-6 mb-5">
      <div className="min-w-0">
        ...
        <h1 className="text-[22px] font-semibold text-ink leading-7">{title}</h1>
        {description ? <p className="text-[13px] text-ink-muted mt-1 max-w-2xl leading-5">{description}</p> : null}
      </div>
...
export function EmptyState({ title, description, action }: { title: string; description?: string; action?: React.ReactNode }) {
  return (
    <div className="rounded-lg border border-dashed border-line-strong px-6 py-9 text-center bg-surface/60">
