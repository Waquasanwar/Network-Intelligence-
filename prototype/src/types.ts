...
export type Person = {
  ...
  workRights?: string[]; amanaBench: boolean; usedByAmana: boolean; screenedAt?: string | null; screeningStatus?: "NONE" | "REGISTERED" | "INVITED" | "BOOKED" | "SUBMITTED" | "APPROVED"; attributes?: FitScores | null; referralConsent?: "yes" | "ask" | "no" | null; memberSince?: string | null; createdAt: string; updatedAt: string;
};
...
export type ShortlistItem = { id: string; briefId: string; personId: string; fitScore: number; fitExplanation: string; dimensions: { name: string; score: number; note: string }[]; uncertainty: string[]; checks: HardCheck[]; tier: "meets" | "conversation" | "stretch"; decision: ShortlistDecision; referred?: boolean; referredBy?: string | null; note?: string | null; clientNote?: string | null; createdAt: string; updatedAt: string };
